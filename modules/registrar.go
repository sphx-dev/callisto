...
import (
	...
	"github.com/forbole/callisto/v4/modules/marginacc"
	"github.com/forbole/callisto/v4/modules/markets"
	"github.com/forbole/callisto/v4/modules/orders"
	"github.com/forbole/callisto/v4/modules/positions"
)
...
func (r *Registrar) BuildModules(ctx registrar.Context) jmodules.Modules {
	...
	marginAccModule := marginacc.NewModule(r.cdc, db, ctx.Logger)
	marketModule := markets.NewModule(r.cdc, db, ctx.Logger)
	orderModule := orders.NewModule(r.cdc, db, ctx.Logger)
	positionModule := positions.NewModule(r.cdc, db, ctx.Logger)
