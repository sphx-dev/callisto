...
import (
	...
	// marginAccsource "github.com/forbole/callisto/v4/modules/marginacc/source"
	// remotemarginAccsource "github.com/forbole/callisto/v4/modules/marginacc/source/remote"
	// marginacctypes "sphx/x/marginacc/types"
)
...
type Sources struct {
	...
	// MarginAccountSource marginAccsource.Source
}
...
func buildRemoteSources(cfg *remote.Details) (*Sources, error) {
	...
	return &Sources{
		...
		// MarginAccountSource: remotemarginAccsource.NewSource(source, marginacctypes.NewQueryClient(source.GrpcConn)),
	}, nil
}
